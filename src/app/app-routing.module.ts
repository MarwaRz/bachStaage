...
const routes: Routes = [
  ...
  { path:'cycle/:idFormation',component:CycleComponent , canActivate:[AuthGuard], data:{roles:['Admin'] }} ,
  ...
  { path: 'imprimer/:idFormation', component: ImprimerComponent, canActivate: [AuthGuard], data: { roles: ['Admin'] } },
